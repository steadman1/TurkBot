...
class PyTorrent:
    def __init__(self, category, save_path="F:\Movies"):
        try:
        ...
        self.save_path = save_path # os.path.join(os.path.dirname(__file__), "movies")
    ...
    def download(self, torrent_id):
        ...
        """
        self.qb.download_from_link(torrent_id, savepath=self.save_path, category=self.category)
